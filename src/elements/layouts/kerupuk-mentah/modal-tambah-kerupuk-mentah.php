        ...
        <div class="modal-content">
            ...
            <form method="post">
                    ...
                    <div class="form-group">
                        <nav>
                            <div class="nav nav-pills nav-justified justify-content-center" id="nav-tab" role="tablist">
                                <button class="nav-link active border-0 rounded-0" id="nav-barang-masuk-tab"
                                    data-toggle="tab" data-target="#nav-barang-masuk" type="button" role="tab"
                                    aria-controls="nav-barang-masuk" aria-selected="true">Barang Masuk</button>
                                <button class="nav-link border-0 rounded-0" id="nav-barang-keluar-tab" data-toggle="tab"
                                    data-target="#nav-barang-keluar" type="button" role="tab"
                                    aria-controls="nav-barang-keluar" aria-selected="false">Barang Keluar</button>
                            </div>
                        </nav>

                        <div class="tab-content" id="nav-tabContent">
                            <!-- Form Barang Masuk -->
                            <div class="tab-pane fade show active mt-3" id="nav-barang-masuk" role="tabpanel"
                                aria-labelledby="nav-barang-masuk-tab">
                            ...
                            <!-- Form Barang Keluar -->
                            <div class="tab-pane fade mt-3" id="nav-barang-keluar" role="tabpanel"
                                aria-labelledby="nav-barang-keluar-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    $mthQty = $rowMth['saldo_qty'];

                                    ?>

                                    <label for="bk_qty">Kuantitas</label>
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="bk_qty" name="bk_qty" min="0"
                                            max="<?= $mthQty; ?>">
                                        <div class="input-group-append">
                                            <div class="input-group-text">Kg</div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="bk_total" id="bk_total"
                                            disabled>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="add_kerupuk_mentah">Simpan</button>
                </div>
            </form>
        </div>
    </div>
