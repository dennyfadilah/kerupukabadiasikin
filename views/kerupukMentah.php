<div class="card">
    <div class="card-body">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-2 text-gray-800">Kerupuk Mentah</h1>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahModal">+ Tambah
                Data</button>
        </div>
        <?php
        $query = mysqli_query($koneksi, "SELECT saldo_harga FROM kerupuk_mentah ORDER BY id_mth DESC LIMIT 1");
        $row = mysqli_fetch_array($query);

        include_once './src/elements/layouts/kerupuk-mentah/modal-tambah-kerupuk-mentah.php' ?>

        <div class="table-responsive">
            <table class="table table-bordered display nowrap" id="kerupuk-mentah" width="100%" cellspacing="0">
                <thead>
                ...
                <tbody>
                    <?php
                    require 'pagesControl/kerupukMentahPage.php';
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <?php require './src/elements/layouts/kerupuk-mentah/modal-edit-kerupuk-mentah.php'; ?>
